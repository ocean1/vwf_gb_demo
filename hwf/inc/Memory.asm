; _ocean
;original work from Carsten Sorensen&others
...
;***************************************************************************
;*
;* mem_monoVRAM - "Copy" a monochrome font from ROM to VRAM
;*
;* input:
;*    a - value
;*   hl - pMem
...
;***************************************************************************
;*
;* mem_Copy2 - "Copy" tiles from a location to another tranforming them
;*              from 1bpp to 2bpp (i.e. you can use it for copying 1bpp
;*              tiles from ROM/RAM to VRAM :)
;* input:
;*   hl - pSource
;*   de - pDest
;*   bc - bytecount
